                    ...
                    if request.method == "POST":
                        ...
                        if passw1 == passw:
                            ...
                            try:
                                ...
                                flash(
                                    "you need to specify ALL of the info!!!", "info")
                ...
                if user != "":
                    ...
                    if request.method == "GET":
                        ...
                        if platform.system() == "windows":
                            totald, usedd, freed = shutil.disk_usage("c:/")
                        else:
                            totald, usedd, freed = shutil.disk_usage("/")
                        diskp = usedd/totald
...
def verif():
    ...
    while True:
        ...
        usedvm = psutil.virtual_memory()[0]
        if len(timelog) >= 60:
            timelog.pop(0)
        timelog.append(gct())
